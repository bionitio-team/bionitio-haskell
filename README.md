[![travis](https://travis-ci.org/bionitio-team/bionitio-haskell.svg?branch=master)](https://travis-ci.org/bionitio-team/bionitio-haskell)

# Overview 

This is a Haskell implementation of [bionitio](https://github.com/bionitio-team/bionitio).
...
We recommend using the `stack` tool to install bionitio. You will need to install `stack` on your system first.
...
```
% bionitio-hs -h
Usage: bionitio-hs [--minlen N] [--version] [--verbose] [[FASTA_FILE ...]]
  Print fasta stats
...
```
% bionitio-hs file1.fa file2.fa file3.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
file1.fa	5264	3801855	31	722	53540
...
```
% bionitio-hs --minlen 1000 file.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
...
```
% bionitio-hs two_sequence.fasta 
